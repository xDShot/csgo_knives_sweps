...
parser.add_argument('-wt', default='weapon_template.txt', help='weapon template file')
parser.add_argument('-wd', default='../lua/weapons/', help='where to save weapons lua files')
parser.add_argument('-pt', default='pointshop_template.txt', help='pointshop item template file')
